...
export default function MenuSection({ lang, content }: MenuSectionProps) {
  ...
  return (
    <section
      style={{ position: "relative", display: "flex", flexDirection: "column", alignItems: "center", overflow: "hidden", padding: "1vh clamp(40px, 10vw, 60px) calc(2vh - 8px)", background: "transparent", minHeight: "100vh", boxSizing: "border-box" }}
    >
